export default {
    ...
    employment: [
        {
            ...
            info2: 'Department of Linguistics and Philosophy',
            date: 'August 2023 — ',
        },
    ],
    ...
    education: [
        ...
        },
        {
            ...
            info: 'B.A. in Mathematics and Philosophy',
    ...
    publications: [
        ...
        },
        {
            ...
            conference: true,
            authors:
                'Stephens, K., Nader, K., Hughes, A., Harris, A., Montagnolo, C., Stevens, A., Senarath, Y., & Purohit, H.',
    ...
    raship: [
        {
            title: 'Bad AI and beyond: Exploring how popular media shapes the perceived opportunities and threats of AI',
